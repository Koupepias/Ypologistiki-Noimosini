...
hidden_neurons = [ I // 2, (2 * I) // 3, I, 2*I ]

# Define available hidden activation functions
...
def evaluate_hyperparameters(X, y, activations_functions, loss_funtions, hidden_neurons):
    ...
    for activation_function in activations_functions:
        for loss_function in loss_funtions:
            for hidden_neurons_count in hidden_neurons:
                print(f"\nEvaluating activation function: {activation_function} with loss function: {loss_function} and hidden neurons: {hidden_neurons_count}")
...
def save_results_to_csv(results, output_dir):
    ...
    summary_filename = os.path.join(output_dir, "act-loss-neurons-tuning.csv")
...
def run_hyperparameter_analysis(X, y, activation_functions, loss_functions, hidden_neurons):
    """Complete workflow for hyperparameter analysis with CSV and PNG exports"""
    # Create output directory
    output_dir = create_output_directory()
    
    # Evaluate hyperparameters
    results = evaluate_hyperparameters(X, y, activation_functions, loss_functions, hidden_neurons)
...
results, output_dir = run_hyperparameter_analysis(X, y, activation_functions, loss_functions, hidden_neurons)
